...
predicted_img1 = cv2.cvtColor(predicted_img1.copy(), cv2.COLOR_BGR2RGB)
predicted_img2 = predict(test_img2)
predicted_img2 = cv2.cvtColor(predicted_img2.copy(), cv2.COLOR_BGR2RGB)
predicted_img3 = predict(test_img3)
predicted_img3 = cv2.cvtColor(predicted_img3.copy(), cv2.COLOR_BGR2RGB)
